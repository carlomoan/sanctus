...
import { Filter, Calendar, FileText, Download, TrendingUp, PieChart, Landmark, ArrowRightLeft, ClipboardList, BarChart3, Printer } from 'lucide-react';
...
const Reports = () => {
  ...
  const exportToPDF = async () => {
    ...
    // For now, we'll use the browser's print functionality which can save as PDF
    handlePrint();
  };
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          >
            <BarChart3 size={20} /> {showCharts ? 'Hide Charts' : 'Show Charts'}
          </button>
          <button className="bg-white text-gray-700 border border-gray-300 px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-gray-50" onClick={handlePrint}>
            <Printer size={20} /> Print
          </button>
          <button className="bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-blue-700" onClick={exportToPDF}>
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 flex flex-wrap gap-4 items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="border border-gray-200 rounded-lg py-2 px-4 bg-white min-w-[160px]"
          >
